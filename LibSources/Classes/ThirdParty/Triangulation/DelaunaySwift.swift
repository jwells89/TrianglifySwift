...
open class Delaunay {
    ...
    fileprivate static func supertriangle(_ vertices: [Vertex]) -> [Vertex] {
    ...
    fileprivate static func circumcircle(_ i: Vertex, j: Vertex, k: Vertex) -> Circumcircle {
        let x1 = i.x
        let y1 = i.y
        let x2 = j.x
        let y2 = j.y
    ...
    fileprivate static func dedup(_ edges: [Vertex]) -> [Vertex] {
    ...
    public static func triangulate(_ vertices: [Vertex]) -> [Triangle] {
